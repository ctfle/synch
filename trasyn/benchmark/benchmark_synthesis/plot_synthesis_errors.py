...
from trasyn.benchmark.utils import (
    ...
    fit_and_plot_with_scipy,
)


dir = ""  # "benchmark_results_100_seed_42_num_attempts_5_varying_num_samples"  #
colors = ["red", "blue", "green", "orange", "black", "yellow"]
labels = [
    "T",
    "T + sqrtT (cost 2.5)",
    "T + sqrtT (cost 2.5)",
    "T + sqrtT (cost 2.5) new partitoner",
    "T + sqrtT (cost 2.5) new partitoner gpu",
    "test",
]
gate_sets_dir = [
    "benchmark_results_100_seed_42_num_attempts_5_max_partition_value=10_varying_num_samples/tshxyz_tequiv_large",
    ...
    "test/filtered_max_num_sqrtt_1/benchmark_results_100_seed_42_num_attempts_5_max_partition_value=7.5_test_new_ergodic_partitioner/filtered/merged/tqshxyz_tequiv_large_cost_2.5_max_num_sqrtt_1",
]
...
for gs, color, label in zip(gate_sets_dir, colors, labels):
    ...
    for budget, path in extract_budget_files(load_dir):
        ...
        print(budgets, sequences[budget])
...
dirs = [
    "benchmark_results_100_seed_42_num_attempts_5_varying_num_samples/tqshxyz_tequiv_medium_cost_2.5",
...
colors = ["red", "blue", "green", "orange", "black", "yellow"]
labels = [
    "T + sqrtT (cost 2.5) original",
    "T + sqrtT (cost 2.5) increased max partition",
    "T + sqrtT (cost 2.5) including permutations",
    "T + sqrtT (cost 2.5) ermutations + better partitioning",
    "T + sqrtT (cost 2.5) ergodic",
]
# ["tshxyz_tequiv_medium", "tqshxyz_tequiv_medium_cost_2.5_large_num_samples" ] # "tqshxyz_tequiv_medium_cost2"
...
dirs = [
    "benchmark_results_100_seed_42_num_attempts_5_max_partition_value=10_varying_num_samples/tshxyz_tequiv_large",
    "benchmark_results_100_seed_42_num_attempts_5_varying_num_samples/tshxyz_tequiv_medium",
]  # "benchmark_results_100_seed_42_num_attempts_5_varying_num_samples"  #
