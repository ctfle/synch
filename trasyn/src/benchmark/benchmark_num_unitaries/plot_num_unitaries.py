...
from trasyn.src.benchmark.utils import get_mean_and_std, extract_budget_files

num_unitaries = [10, 50, 100, 200, 500, 1000]  # 100000]
dirs = [
    f"./benchmark_results_{n}_seed_42_num_attempts_5_num_samples_1000"
    for n in num_unitaries
]
