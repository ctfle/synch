...
ORIG_DIR = f"{os.path.dirname(os.path.abspath(__file__))}/assets/{nonclifford_gates}{clifford_gates}_medium/"

# New directory for T-equivalent grouping (output)
NEW_DIR = f"{os.path.dirname(os.path.abspath(__file__))}/assets/{nonclifford_gates}{clifford_gates}_tequiv_medium_cost_2.5/"
