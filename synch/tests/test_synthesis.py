...
import numpy as np
import pytest
from synch.src.synthesis import Synthesiser, ErgodicPartitioner
from synch.src.utils import random_unitary_2x2, seq2mat, distance
...
class TestSynthesis:
    ...
    def test_reverse_engineer_synthesis(self, budget, load_dir, costs):
        ...
        """
        target_unitary_seq = unitary_from_budget(
            t_budget=budget, q_budget=0, total_len=10
        )
